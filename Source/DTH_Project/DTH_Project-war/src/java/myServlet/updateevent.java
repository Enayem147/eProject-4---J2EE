    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("txtDecription") != null) {
                des = request.getParameter("txtDecription");
            }

            String date1 = "";
            if (request.getParameter("txtStart") != null) {
                date1 = request.getParameter("txtStart");
            }

            String date2 = "";
            if (request.getParameter("txtEnd") != null) {
                date2 = request.getParameter("txtEnd");
            }
            ...
            if (m.update(id, eventname, des, filename, new Timestamp(Timestamp.parse(date1)), new Timestamp(Timestamp.parse(date2)), reward)) {
                RequestDispatcher dis = request.getRequestDispatcher("admin_page/List_Event.jsp");
