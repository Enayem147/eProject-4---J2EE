...
public class addnews extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             ...
             */
            int id = mySessionbean.getNewsid();
            /*
             Lay gia tri tu nguoi dung
             */
            String introduction = "";
            if (request.getParameter("txtIntroduction") != null) {
                introduction = request.getParameter("txtIntroduction");
            }
            ...
            String postname = "";
            if (request.getParameter("txtDecription1") != null) {
                postname = request.getParameter("txtDecription1");
            }
            ...
            if (m.add(id + 1, introduction, title, description1, filename1, description2, filename2, postname, new Timestamp(date.getTime()))) {
